...
(function () {
    ...
    window.Framework7 = function (params) {
        ...
        ************   Modals   ************
        ...
        app.confirm = function (text, title, callbackOk, callbackCancel, btn1, btn2) {
            if (typeof title === 'function') {
            ...
            return app.modal({
                ...
                title: typeof title === 'undefined' ? app.params.modalTitle : title,
                buttons: [
                    {text: btn1?btn1:app.params.modalButtonCancel, onClick: callbackCancel},
                    {text: btn2?btn2:app.params.modalButtonOk, bold: true, onClick: callbackOk}
                ]
            });
        };
